...
# In Rails environment, these are likely autoloaded, but we explicitly require TUI components
# if they are not picked up by Zeitwerk or to be safe.
  ...
  module Tui
    ...
    class App
      ...
      def toggle_locale
        ...
        log(Ksef::I18n.t("app.locale_changed", lang: new_locale))
      end
